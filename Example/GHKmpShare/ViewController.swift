...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let param: [String: Any] = [
            ...
            "configType": 5,
            "sceneCode": 20008,
            "speedInfo": ["config": "{\"minSpeedValue\":50,\"overly\":[{\"speedValue\":70,\"layerFlag\":1,\"layerIndex\":0},{\"speedValue\":70,\"layerFlag\":2,\"layerIndex\":1}],\"maxSpeedValue\":100,\"currentSpeedValue\":70}"]
        ]
...
//        
//        _ = KMPSharedBiz.shared.changeAll(speedVal: 80, directionVal: 1, colorH: 20, param: param, device: device)
        
        KMPSharedBiz.shared.changeSpeed(value: 80, param: param, device: device)
        
//        KMPSharedBiz.shared.changeDirection(code: 1, param: param, device: device)
